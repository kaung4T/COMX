 ...
 *
 * @uses pleased_header_style()
 */
function pleased_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'pleased_custom_header_args', array(
		'default-image'          => '%s/assets/uploads/header-image.jpg',
		'default-text-color'     => '181818',
		'width'                  => 1200,
		'height'                 => 528,
		'flex-height'            => true,
		'wp-head-callback'       => 'pleased_header_style',
	) ) );
	...
	register_default_headers( array(
		'default-image' => array(
			...
			'description'   => esc_html__( 'Default Header Image', 'pleased' ),
		),
	) );
}
add_action( 'after_setup_theme', 'pleased_custom_header_setup' );

if ( ! function_exists( 'pleased_header_style' ) ) :
	/**
	 * Styles the header image and text displayed on the blog.
	 *
	 * @see pleased_custom_header_setup().
	 */
	function pleased_header_style() {
		...
		wp_add_inline_style( 'pleased-style', $css );
	}
endif;
add_action( 'wp_enqueue_scripts', 'pleased_header_style', 10 );