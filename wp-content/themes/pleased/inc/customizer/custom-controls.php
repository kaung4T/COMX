 ...
 */
class Pleased_Dropdown_Taxonomies_Control extends WP_Customize_Control {
    ...
    <label>
      ...
      <?php endif; ?>
       <select <?php $this->link(); ?>>
			<?php
			printf( '<option value="%s" %s>%s</option>', '', selected( $this->value(), '', false ), esc_html__('--None--', 'pleased') );
			?>
 ...
 * @see WP_Customize_Control
 */
class Pleased_Dropdown_Category_Control extends WP_Customize_Control {
...
class Pleased_Note_Control extends WP_Customize_Control {
...
class Pleased_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class Pleased_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="pleased-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 */
class Pleased_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class Pleased_Icon_Picker extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <input id="pleased-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'pleased' ); ?>" class="pleased-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
            </label>
		<?php
	}
}
...
Class Pleased_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
 ...
 * @since  1.0.0
 */
class Pleased_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
